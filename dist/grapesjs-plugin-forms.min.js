         ...
         var o = n(0),
            ...
            h = function(e) {
               var t = e.DomComponents,
                  ...
                  h = { name: 'placeholder' },
                  f = { name: 'value' },
                  v = { type: 'checkbox', name: 'required' },
                  g = { type: 'checkbox', name: 'checked' }
               t.addType(a, {
                  ...
                  model: {
                     defaults: {
                        ...
                        droppable: ':not(form)',
                        draggable: ':not(form)',
                        attributes: { method: 'get', style: 'padding: 50px;' },
                        traits: [
                           {
                              type: 'select',
                              name: 'method',
                           ...
                           { name: 'action' },
                           {
                              ...
                              command: editor => {
                                 ...
                                 traits.forEach(trait => {
                                    const { id, type, value } = trait.props()
                                    if (type != 'button') {
                                       items.push({
                                          id,
                                          value,
               ...
               var b = function(e, t) {
                  return { type: d, components: t, attributes: { value: e } }
               }
               t.addType(s, {
                  extend: i,
                  isComponent: function(e) {
                  ...
                  t.addType(p, {
                     ...
                     view: {
                        ...
                        handleChecked: function() {
                           this.el.checked = !!this.model.get('attributes')
                              .checked
                        },
                     },
                  }),
            ...
            r(a, {
               ...
               content: {
                  ...
                  components: [
                     {
                        components: [
                           { type: m, components: 'Name' },
                           { type: i },
                        ],
                     },
                     {
                        components: [
                           { type: m, components: 'Email' },
                           { type: i, attributes: { type: 'email' } },
                        ],
                     },
                     {
                        components: [
                           { type: m, components: 'Gender' },
                           { type: p, attributes: { value: 'M' } },
                           { type: m, components: 'M' },
                           { type: p, attributes: { value: 'F' } },
                           { type: m, components: 'F' },
                        ],
                     },
                     {
                        components: [
                           { type: m, components: 'Message' },
                           { type: c },
                        ],
                     },
                     { components: [{ type: l }] },
